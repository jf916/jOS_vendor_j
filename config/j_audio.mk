...
ALARM_PATH := vendor/j/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/j/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/j/prebuilt/common/media/audio/ringtones
